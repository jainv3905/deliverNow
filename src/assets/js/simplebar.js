...
!(function (t, e) {
                ...
                ? J
                    ? function (t, e, r) {
                        if ((tt(t), (e = vt(e)), tt(r), "function" == typeof t && "prototype" === e && "value" in r && "writable" in r && !r.writable)) {
                            var n = yt(t, e);
                            n && n.writable && ((t[e] = r.value), (r = { configurable: "configurable" in r ? r.configurable : n.configurable, enumerable: "enumerable" in r ? r.enumerable : n.enumerable, writable: !1 }));
                        }
                        return bt(t, e, r);
                    }
                    : bt
        ...
        Xr = function () {
            ...
            Xr =
                "undefined" != typeof document
                    ? document.domain && Ir
                        ? $r(Ir)
                        : (((e = U("iframe")).style.display = "none"), Br.appendChild(e), (e.src = String("javascript:")), (t = e.contentWindow.document).open(), t.write(Vr("document.F=Object")), t.close(), t.F)
                    : $r(Ir);
    ...
    var cn = { IteratorPrototype: Ur, BUGGY_SAFARI_ITERATORS: an },
        ...
        On = function (t, e, r, n, i, o, s) {
            ...
            if (
                (g && (a = on(g.call(new t()))) !== Object.prototype && a.next && (on(a) !== mn && (gn ? gn(a, mn) : T(a[En]) || Ht(a, En, wn)), fn(a, f, !0)),
                    bn &&
                    "values" == i &&
                    p &&
                    "values" !== p.name &&
                ...
                if (((c = { values: u("values"), keys: o ? v : u("keys"), entries: u("entries") }), s)) for (l in c) (xn || h || !(l in d)) && Ht(d, l, c[l]);
    ...
    function Ui(t, e, r) {
        ...
        return (
            (e = Ji(e) || 0),
            Ki(r) && ((u = !!r.leading), (o = (f = "maxWait" in r) ? qi(Ji(r.maxWait) || 0, e) : o), (h = "trailing" in r ? !!r.trailing : h)),
            (y.cancel = function () {
    ...
    var Qi = function (t, e, r) {
        var n = !0,
            i = !0;
        if ("function" != typeof t) throw new TypeError("Expected a function");
        return Ki(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)), Ui(t, e, { leading: n, maxWait: e, trailing: i });
    },
        Zi = /^\s+|\s+$/g,
        to = /^[-+]0x[0-9a-f]+$/i,
        eo = /^0b[01]+$/i,
    ...
    var po = function (t, e, r) {
        ...
        return (
            (e = ho(e) || 0),
            fo(r) && ((u = !!r.leading), (o = (f = "maxWait" in r) ? co(ho(r.maxWait) || 0, e) : o), (h = "trailing" in r ? !!r.trailing : h)),
            (y.cancel = function () {
                void 0 !== a && clearTimeout(a), (l = 0), (n = c = i = a = void 0);
            }),
            (y.flush = function () {
    ...
    var Xo,
        ...
        os = function (t, e) {
            ...
            var r = getComputedStyle(t),
                ...
                A = O + v + x + b,
                k = S + g + m + y,
                T = Ho({ devicePixelContentBoxSize: ns(Math.round(O * devicePixelRatio), Math.round(S * devicePixelRatio), o), borderBoxSize: ns(A, k, o), contentBoxSize: ns(O, S, o), contentRect: new Yo(f, c, O, S) });
            return Qo.set(t, T), T;
        },
        ss = function (t, e, r) {
            var n = os(t, r),
        ...
        fs = function () {
            ...
            return (
                ...
                }) && ("function" == typeof ErrorEvent ? (t = new ErrorEvent("error", { message: $o })) : ((t = document.createEvent("Event")).initEvent("error", !1, !1), (t.message = $o)), window.dispatchEvent(t)),
                e > 0
            );
        },
        hs = [],
            ...
            if (
                (d &&
                    ((p = Ks(p, "y", "")),
                        -1 === Us(p, "g") && (p += "g"),
                        (b = Js(u, c.lastIndex)),
                        c.lastIndex > 0 && (!c.multiline || (c.multiline && "\n" !== Gs(u, c.lastIndex - 1))) && ((v = "(?: " + v + ")"), (b = " " + b), g++),
                        (r = new RegExp("^(?:" + v + ")", p))),
                    ta && (r = new RegExp("^" + v + "$(?!\\s)", p)),
                    Qs && (n = c.lastIndex),
                    (i = rt(qs, d ? r : c, b)),
                    d ? (i ? ((i.input = Js(i.input, g)), (i[0] = Js(i[0], g)), (i.index = c.lastIndex), (c.lastIndex += i[0].length)) : (c.lastIndex = 0)) : Qs && i && (c.lastIndex = c.global ? i.index + i[0].length : n),
                    ta &&
                    i &&
                    i.length > 1 &&
            ...
            if (!o || !s || r) {
                var a = g(/./[i]),
                    c = e(i, ""[t], function (t, e, r, n, i) {
                        var s = g(t),
                            c = e.exec;
                        return c === ea || c === na.exec ? (o && !i ? { done: !0, value: a(e, r, n) } : { done: !0, value: s(r, e, n) }) : { done: !1 };
                    });
    ...
    return (
        ...
        (Fa.initHtmlApi = function () {
            (this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this)),
                "undefined" != typeof MutationObserver && ((this.globalObserver = new MutationObserver(Fa.handleMutations)), this.globalObserver.observe(document, { childList: !0, subtree: !0 })),
                ...
                Array.prototype.forEach.call(t.addedNodes, function (t) {
                    1 === t.nodeType &&
                        (t.hasAttribute("data-simplebar")
                            ? !Fa.instances.has(t) && document.documentElement.contains(t) && new Fa(t, Na(t.attributes))
